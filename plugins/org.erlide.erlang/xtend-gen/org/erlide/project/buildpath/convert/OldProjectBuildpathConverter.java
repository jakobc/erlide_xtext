...
public class OldProjectBuildpathConverter {
  ...
  public String debugPrint(final OldErlangProjectProperties props) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("src = \u00B4PathSerializer::packList(props.sourceDirs)\u00AA");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("inc = \u00B4PathSerializer::packList(props.includeDirs)\u00AA");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("out = \u00B4PathSerializer::packList(props.outputDirs)\u00AA");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("ver = \u00B4props.runtimeVersion\u00AA");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("xmd = \u00B4props.externalModulesFile\u00AA");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("xin = \u00B4props.externalIncludesFile\u00AA");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
